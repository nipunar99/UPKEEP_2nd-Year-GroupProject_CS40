...
class ViewItem {
    ...
    public function generateReminder($task_ID){
        ...
        if($result[0]->status==='Active'){
            $years = intval($result[0]->years); unset($result[0]->years);
            $months = intval($result[0]->months);unset($result[0]->months);
            $weeks = intval($result[0]->weeks);unset($result[0]->weeks);
            
            $start_date = new DateTime($result[0]->	rerun_date);unset($result[0]->rerun_date);
