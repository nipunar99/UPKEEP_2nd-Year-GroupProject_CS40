...
<body>
    <div class="container">
        ...
        <main>
        <div class="mainhead" style="margin-left:3rem;margine-right:3rem;gap=0rem;margin-top 10px;">
            ...
            <h2>Verification Request</h2></div>
                        ...
                        <div class="container" style="display: flex;
                            ...
                            <div class="middle" style="margin:-2rem;">
                                ...
                                <div style="margin-left:9rem;">
                                    <span class="guy"><h4>Auto Mobile|Maharagama</h4></span>
                                </div>
