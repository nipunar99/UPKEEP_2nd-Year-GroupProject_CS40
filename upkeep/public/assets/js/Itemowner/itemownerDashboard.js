...
function ajax_getAllOverdueReminders() {
    ...
    xhr.open('GET',"http://localhost/upkeep/upkeep/public/Itemowner/Userdashboard/getAllOverdueReminders");
...
function display1details(){
    ...
    xhr.open("GET","http://localhost/upkeep/upkeep/public/Itemowner/Userdashboard/display1details");
...
function display2details(){
    ...
    xhr.open("GET","http://localhost/upkeep/upkeep/public/Itemowner/Userdashboard/display2details");
...
function display3details(){
    ...
    xhr.open("GET","http://localhost/upkeep/upkeep/public/Itemowner/Userdashboard/display3details");
